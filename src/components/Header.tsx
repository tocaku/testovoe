    ...
    <header id="header" className="bg-white shadow-md">
      <div className="flex justify-between items-center py-4 px-8 border-b">
        <div className="text-gray-800 flex items-center space-x-2">
          ...
          <div className="flex flex-col">
            <span>Корзина (5):</span>
            <span className="font-semibold text-black">34 000 $</span>
          </div>
        </div>
        ...
        <div className="text-gray-800">
          <a href="tel:88003027915" className="font-semibold">
            8 (800) 302 79 15
          </a>
          <br />
          <Link
            to="/contact"
            className="text-sm text-yellow-500 underline hover:text-yellow-600"
          >
      ...
      <nav className="bg-gray-100 py-3">
        <div className="flex justify-center space-x-8 text-gray-700 text-sm font-medium">
          ...
          <Link to="/watches" className="hover:text-black">
            ЧАСЫ
          </Link>
          <Link to="/bags" className="hover:text-black">
            СУМКИ
          </Link>
          <Link to="/backpacks" className="hover:text-black">
            РЮКЗАКИ
          </Link>
          <Link to="/wallets" className="hover:text-black">
            КОШЕЛЬКИ
          </Link>
          <Link to="/bracelets" className="hover:text-black">
            БРАСЛЕТЫ
          </Link>
